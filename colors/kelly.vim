...
hi Number		ctermfg=21  gui=none
hi Comment 		ctermfg=167 gui=italic
...
hi Function 	ctermfg=28  gui=none
hi Type 	   	ctermfg=15  gui=none
hi Statement 	ctermfg=75  gui=none
hi Keyword		ctermfg=75  gui=none
